        ...
        <div className="grid-1 grid gap-8 md:grid-cols-3 lg:grid-cols-3">
          ...
          <div className="cursor-pointer">
            ...
            <p className="mb-5 flex items-center sm:text-lg justify-center md:justify-start">
              ...
              <span className="text-gray-400">Kalabhavan , Rajmahal Road,<br></br>
                Vadodara, Gujarat 390001</span>
            </p>
            <a
              className="mb-4 flex items-center sm:text-lg justify-center md:justify-start"
              href="Mailto:gujaratentranceexam4help@gmail.com"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <span className="text-gray-400">
                gujaratentranceexam4help@gmail.com
              </span>
            </a>
            <a
              className="mb-4 flex items-center sm:text-lg justify-center md:justify-start"
              href="Tel:011-23456789"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <span className="text-gray-400">011-23456789</span>
            </a>
          </div>
          ...
          <div className="cursor-pointer bg-gray-300 rounded-lg overflow-hidden relative flex ">
            ...
            ></iframe> */}
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1969.1694750186412!2d73.19544602929619!3d22.297664276062143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc5f655609b13%3A0xfd911fb985200eea!2sKalabhavan!5e0!3m2!1sen!2sin!4v1713935558533!5m2!1sen!2sin"
              width="600"
              height="200"
              loading="lazy"
