...
public class AdmitCardUtil {
    ...
    private static void addHeader(Document document){
        Chunk headerChunk = new Chunk("Gujarat Entrance Exam (Mains)", AdmitCardFont.HEADER_FONT.getFont());
...
//        headerImageCell.setTop(15f);
    ...
    private static void addBasicDetails(Document document, RegistrationForm form){
        ...
        addRowToTable(basicDetailsTable, "First Name", form.getFirstName(),1, 0);
        addRowToTable(basicDetailsTable, "Last Name", form.getLastName(),2, 0);
        addRowToTable(basicDetailsTable, "Gender", form.getGender(),3, 0);
        addRowToTable(basicDetailsTable, "DOB", form.getDob().toString(),4, 0);
        addRowToTable(basicDetailsTable, "Signature", form.getSign(),4,2);
    ...
    private static void addDirectorSignature(Document document) {
        ...
        Chunk directorTextChunk = new Chunk("Director GEE", AdmitCardFont.FIELD_VALUE_FONT.getFont());
